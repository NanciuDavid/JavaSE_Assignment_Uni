...
sudo javac eu/deic/oop/oop/Main.java
sudo javac eu/deic/oop/oop/Car.java
sudo javac eu/deic/oop/oop/UserInterface.java

if [ $? -eq 0 ]; then
    echo "Compilation successful - OOP version"

    java eu/deic/oop/oop/Main.java
